...
echo "✅ All production dependencies use permissive licenses (MIT, Apache-2.0)"
echo "✅ Third-party attributions are properly documented"
echo "✅ FluentAssertions licensing concern is documented and limited to test environment"
echo ""
