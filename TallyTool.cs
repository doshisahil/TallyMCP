...
public static class TallyPrompt
{
    ...
    [McpServerPrompt, Description("Returns a comprehensive, step-by-step prompt template for automated extraction and classification of bank statement transactions from a PDF. Guides the use of PDF text extraction, company and ledger identification tools, and supports password-protected PDFs.")]
    public static string GetAutomatedBankStatementExtractionPrompt()
    {
        ...
        "   - For each transaction, use the narration and other details to determine the most appropriate `ToLedger` and `FromAccount` from the available ledgers only strictly with same case.\n" +
